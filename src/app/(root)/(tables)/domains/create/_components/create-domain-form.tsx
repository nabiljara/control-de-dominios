...
import { ContactInfoCard } from "@/app/(root)/(tables)/clients/_components/contact-info-card"
...
export default function CreateDomainForm({
  ...
  //Accesos del cliente con la relación de proveedores
  ...
  const handleFinalSubmit = async () => {
    ...
    toast.promise(
      new Promise<void>(async (resolve, reject) => {
        try {
          const accessId = form.getValues("isClientAccess") ? form.getValues("accessId") : undefined
          if (domain) {
  ...
  const form = useForm<DomainFormValues>({
    ...
    defaultValues: {
      ...
      isClientContact: diffFromUndefinedContact && domain?.contact.clientId === domain?.clientId,
  ...
  //useEffect para buscar los accesos entre el cliente y proveedor
  ...
  }, [clientId, providerId, newClientAccessCreated])
