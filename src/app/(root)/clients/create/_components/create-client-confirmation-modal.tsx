...
export function CreateClientConfirmationModal(
  {
    handleSubmit,
    contacts,
    accesses,
            ...
            <CardContent className="pt-4">
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium">Tamaño:</span> <Badge variant='outline' className={sizeConfig[form.getValues('size')].color}>{form.getValues('size')}</Badge>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4" />
                  <span className="font-medium">Estado:</span>
                  <Badge variant='outline' className={statusConfig[form.getValues('status')].color}>
