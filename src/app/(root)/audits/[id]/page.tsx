...
import { DomainAccessEntityDetails } from "../_components/entity-details/domain-access-entity-details";
    ...
    <div className="space-y-6 p-6">
      <Card>
        ...
        <CardContent className="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          <div className="col-span-2 grid gap-4 lg:col-span-4">
            ...
            {audit.entityDetails ? (
              (() => {
                switch (audit.entity) {
                  ...
                  case "Acceso del dominio":
                    return <DomainAccessEntityDetails {...audit} />;
                  default:
          ...
          <Table>
            ...
            <TableBody>
              {audit.audit_details.map((detail) =>
                detail.field === "Fecha de vencimiento" ||
                detail.field === "Última modificación" ||
